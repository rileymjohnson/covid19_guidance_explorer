...
if not config['general']['debug']:
    ...
    admin.add_view(ModelView(DocumentTagThroughTable, category='Through Tables'))
    admin.add_view(ModelView(DocumentJurisdictionThroughTable, category='Through Tables'))
    admin.add_view(ModelView(DocumentDocumentTypeThroughTable, category='Through Tables'))
    admin.add_view(ModelView(DocumentVersionTagThroughTable, category='Through Tables'))
    admin.add_view(ModelView(DocumentVersionJurisdictionThroughTable, category='Through Tables'))
    admin.add_view(ModelView(DocumentVersionDocumentTypeThroughTable, category='Through Tables'))
