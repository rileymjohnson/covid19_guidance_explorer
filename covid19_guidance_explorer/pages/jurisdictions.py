...
def jurisdictions_delete_handler(_, jurisdiction_id):
    DocumentJurisdictionThroughTable \
        .delete() \
        .where(DocumentJurisdictionThroughTable.jurisdiction_id == jurisdiction_id) \
        .execute()

    DocumentVersionJurisdictionThroughTable \
        .delete() \
        .where(DocumentVersionJurisdictionThroughTable.jurisdiction_id == jurisdiction_id) \
        .execute()
...
def handled_table(_, __, page, rows_per_page, ___, ____, search_text):
    ...
    num_pages = Jurisdiction.get_num_pages(
        n=n,
        search_string=search_string
    )
...
clientside_callback(
    ...
    () => (
        dash_clientside.callback_context.triggered[0]?.prop_id !==
            'jurisdictions-table-pagination.active_page' ? 1 : dash_clientside.no_update
    )
    """,
...
def layout() -> html.Div:
    return html.Div(
        [
            ...
            dbc.Toast(
                [
                    html.P('The jurisdiction has been deleted.', className='mb-0')
                ],
                header='Success',
                icon='success',
                duration=4000,
                    ...
                    dbc.ModalFooter(
                        [
                            dbc.Button(
                                ...
                                className='ms-auto',
                                color='danger',
                                id='jurisdictions-delete-are-you-sure-modal-delete-button'
                            ),
                            dbc.Button(
                                'Cancel',
                                color='warning',
                                id='jurisdictions-delete-are-you-sure-modal-cancel-button'
                            )
                        ]
                    ),
                ],
                                ...
                                dbc.Col(
                                    [
                                        ...
                                        dbc.Input(
                                            ...
                                            id='jurisdictions-add-jurisdiction-modal-label-input'
                                        )
                                    ]
                                )
                            ),
                                ...
                                dbc.Col(
                                    [
                                        ...
                                        dbc.Input(
                                            ...
                                            id='jurisdictions-add-jurisdiction-modal-value-input'
                                        )
                                    ]
                                ),
                                class_name='mt-2'
                    ...
                    dbc.ModalFooter(
                        [
                            dbc.Button(
                                ...
                                className='ms-auto',
                                color='success',
                                id='jurisdictions-add-jurisdiction-modal-save-button'
                            ),
                            dbc.Button(
                                'Cancel',
                                color='warning',
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.H1('Jurisdictions', className='h3'),
                        width=5
                    ),
                    dbc.Col(
                        dbc.Row(
